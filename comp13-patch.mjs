...
export function applyComp13Candidate(input){
  ...
  if(!html.includes('avg>=.88&&floor>=.65'))throw new Error('COMP-1.3 completion patch failed');
  if(!html.includes("readiness '+avg+'% / ≥88"))throw new Error('COMP-1.3 finish-gate patch failed');
  return html;
}
